...
maya.window(title = "Create Nuke Project v1.3(VHQ)",w = 510,h = 420)
...
maya.rowColumnLayout(numberOfColumns=2,columnAttach=[1,"right",0],columnWidth=[(1,100),(2,300)])
...
#maya.button(label="Open Nuke Project!",w = 100, align = "center",command ="threading_function('\"C:/Program Files/Nuke8.0v5/Nuke8.0.exe\" --nukex',projpath)")
...
maya.frameLayout( label='Alembic Exporter', borderStyle='in',marginHeight = 4,backgroundColor = [0.35,0.35,0.35] )
maya.columnLayout()

#maya.frameLayout( label='           Set Alembic Parameter', borderStyle='etchedOut' )
maya.rowColumnLayout(numberOfColumns=2,columnAttach=[1,"right",0],columnWidth=[(1,100),(2,400)])

maya.text(label = "export path")
...
maya.text(label = "")
maya.text(label="  This tool is written for creating nuke project which cast UV sequence to model.\n\
  It also add a part to export Alembic file.",align = 'left',w = 500)
maya.text(label = "")
